...
[![CI/CD Pipeline](https://github.com/sukgu/shadow-automation-selenium/actions/workflows/ci-cd.yml/badge.svg)](https://github.com/sukgu/shadow-automation-selenium/actions/workflows/ci-cd.yml)
...
### What's New 
##### We support now Selenium version 4 with release of Shadow version 0.1.6
##### Java 11 and Selenium 4.16.1 to be used with Shadow 0.1.6
...
###### How to use this plugin:
  ...
  **Gradle**
  ```
  implementation 'io.github.sukgu:automation:0.1.6'
  ```
  
  
 You can download the jar file from repository http://central.maven.org/maven2/io/github/sukgu/automation/0.1.6/automation-0.1.6.jar
