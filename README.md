...
###### How to use this plugin:
  ...
  **Gradle**
  ```
  implementation 'io.github.sukgu:automation:0.0.7'
  ```
  
  
 You can download the jar file from repository http://central.maven.org/maven2/io/github/sukgu/automation/0.0.7/automation-0.0.7.jar
